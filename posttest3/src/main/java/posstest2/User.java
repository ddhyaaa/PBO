...
public class User extends Akun {
    ...
    // public void setDataBunga(ArrayList<Bunga> dataBunga) {
    //     this.DataBunga = dataBunga;
    // }

    // public void setKelolaPesanan(KelolaPesanan kelolaPesanan) {
    //     this.kelolaPesanan = kelolaPesanan;
    // }
    ...
    public void pesanBunga() throws IOException {
        ...
        if (bungaDipesan != null) {
            ...
            if (jumlahPesanan <= 0) {
                ...
                KelolaPesanan.tambahPesanan(new Pesanan(this.loggedInUsername, bungaDipesan, jumlahPesanan, "Belum dikonfirmasi"));
    ...
    public static void lihatPesanan(KelolaPesanan kelolaPesanan, String loggedInUsername) {
        System.out.println("=================================");
        ...
        while (exit) {
            ...
            try {
                ...
                switch (pilih) {
                    ...
                    case 3:
                        Utilitas.clear();
                        lihatPesanan(kelolaPesanan, loggedInUsername);
                        Utilitas.pause();
                        break;
                    case 4:
