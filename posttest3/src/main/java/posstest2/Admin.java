...
public class Admin extends Akun {
    ...
    public void lihatPesanan() {
        ArrayList<Pesanan> semuaPesanan = KelolaPesanan.getDataPesanan();
        if (semuaPesanan.isEmpty()) {
            System.out.println("Tidak ada pesanan dari seluruh user.");
        } else {
    ...
    public void konfirmasiPesanan(int idPesanan, String status) {
        ArrayList<Pesanan> dataPesanan = KelolaPesanan.getDataPesanan();
                ...
                try {
                    ...
                    switch (pilih) {
                        ...
                        case 5:
                            ...
                            lihatPesanan();
                            System.out.println("============================================");
                            System.out.print("Masukkan ID pesanan (ketik '00' untuk kembali): ");
                            String inputId = input.readLine().trim();
                            if (inputId.equals("00")) {
                            ...
                            System.out.print("Masukkan status pesanan (diterima/ditolak): ");
